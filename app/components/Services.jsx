...
const Services = () => {
    return (
        <section className="md:flex md:justify-center md:items-center md:gap-20 ">
            <div>
                <div className="flex justify-center ">
                    <div className="flex flex-col gap-1">
                        ...
                        <p className="text-5 text-5xl text-secondary font-bold md:text-7xl">Especialización</p>
                    </div>
                </div>
            ...
            <Image className="md:w-2/5" src={MujerJusticia} width={1000} height={1000} alt="Mujer Justicia" />
        </section>
    )
}
